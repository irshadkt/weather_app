...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  String _getErrorMessage(String error) {
    ...
    // Server errors
    else if (errorLower.contains('status: 5') ||
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          if (currentCity != null && currentCity!.isNotEmpty) {
            context.read<WeatherBloc>().add(RefreshWeatherEvent(currentCity!));
          }
        },
        child: ListView(
              ...
              child: BlocBuilder<WeatherBloc, WeatherState>(
                builder: (context, state) {
                  if (state is WeatherInitial) {
                    return Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            'Get live weather forecasts for your\ncurrent location or search any city worldwide.',
                            textAlign: TextAlign.center,
                            style: TextStyle(
                    ...
                    return const Column(children: [WeatherLoadingShimmer()]);
